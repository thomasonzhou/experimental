  ...
  if (ImGui::CollapsingHeader("Configuration")) {
    ...
    if (ImGui::TreeNode("Configuration##2")) {
      ...
      if (io.ConfigFlags & ImGuiConfigFlags_ViewportsEnable) {
        ...
        ImGui::Checkbox("io.ConfigViewportPlatformFocusSetsImGuiFocus",
                        &io.ConfigViewportPlatformFocusSetsImGuiFocus);
        ImGui::SameLine();
        HelpMarker(
            "When a platform window is focused (e.g. using Alt+Tab, clicking "
            "Platform Title Bar), apply corresponding focus on imgui windows "
            "(may clear focus/active id from imgui windows location in other "
      ...
      // ImGui::SameLine(); HelpMarker("Experimental: Automatically update
      // style.FontScaleDpi when Monitor DPI changes. This will scale fonts but
      // NOT style sizes/padding for now.");
      // ImGui::Checkbox("io.ConfigDpiScaleViewports",
      // &io.ConfigDpiScaleViewports); ImGui::SameLine();
      // HelpMarker("Experimental: Scale Dear ImGui and Platform Windows when
      // Monitor DPI changes.");
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref) {
  ...
  if (BeginTabBar("##tabs", ImGuiTabBarFlags_None)) {
    if (BeginTabItem("Sizes")) {
      ...
      SliderFloat("DockingSeparatorSize", &style.DockingSeparatorSize, 0.0f,
                  12.0f, "%.0f");
