...
//  ImGuiPlatformIO interface. 2025-07-22: OpenGL: Add and call embedded loader
//  shutdown during ImGui_ImplOpenGL3_Shutdown() to facilitate multiple
//  init/shutdown cycles in same process. (#8792) 2025-07-15: OpenGL: Set
//  GL_UNPACK_ALIGNMENT to 1 before updating textures (#8802) + restore
//  non-WebGL/ES update path that doesn't require a CPU-side copy. 2025-06-11:
//  OpenGL: Added support for ImGuiBackendFlags_RendererHasTextures, for dynamic
//  font atlas. Removed ImGui_ImplOpenGL3_CreateFontsTexture() and
