...
struct ImGuiIO {
  ...
  bool ConfigViewportsNoDefaultParent;  // = false          // Disable default
                                        ...
                                        // windows.
  bool ConfigViewportPlatformFocusSetsImGuiFocus;  //= true // When a platform
  ...
  bool ConfigDpiScaleFonts;  // = false          // [EXPERIMENTAL] Automatically
                             // overwrite style.FontScaleDpi when Monitor DPI
                             // changes. This will scale fonts but _NOT_ scale
                             // sizes/padding for now.
  bool ConfigDpiScaleViewports;  // = false          // [EXPERIMENTAL] Scale
                                 // Dear ImGui and Platform Windows when Monitor
                                 // DPI changes.
...
struct ImFontAtlas {
  ...
  // OBSOLETED in 1.92.X: Force texture width before calling Build(). Must be a
...
inline bool BeginChildFrame(ImGuiID id, const ImVec2& size,
                            ImGuiWindowFlags window_flags = 0) {
  return BeginChild(id, size, ImGuiChildFlags_FrameStyle, window_flags);
}
inline void EndChildFrame() { EndChild(); }
// inline bool       BeginChild(const char* str_id, const ImVec2& size_arg, bool
// borders, ImGuiWindowFlags window_flags){ return BeginChild(str_id, size_arg,
// borders ? ImGuiChildFlags_Borders : ImGuiChildFlags_None, window_flags); } //
// Unnecessary as true == ImGuiChildFlags_Borders inline bool BeginChild(ImGuiID
// id, const ImVec2& size_arg, bool borders, ImGuiWindowFlags window_flags) {
