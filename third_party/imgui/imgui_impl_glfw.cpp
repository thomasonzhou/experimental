...
static void ImGui_ImplGlfw_CreateWindow(ImGuiViewport* viewport) {
  ...
  // Workaround for Linux: ignore mouse up events corresponding to losing focus
  // of the previously focused window (#7733, #3158, #7922)
#ifdef __linux__
...
static void ImGui_ImplGlfw_ShowWindow(ImGuiViewport* viewport) {
  ...
  // GLFW hack: install WndProc for mouse source event and WM_NCHITTEST message
  // handler.
